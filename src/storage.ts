 ...
 * runDetection produce the same shape, mirroring emptyDetectionResult() on the
 * engine side.
 */
export function stampResult(result: DetectionResult, routeMode?: RouteMode): StoredAnalysisResult {
