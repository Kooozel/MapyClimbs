...
import { DEFAULT_CLIMB_CONFIG } from "./climb-engine.config";
...
export { DEFAULT_CLIMB_CONFIG } from "./climb-engine.config";
export type { ClimbConfig } from "./climb-engine.config";
